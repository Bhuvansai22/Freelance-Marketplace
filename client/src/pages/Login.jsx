  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-slate-50 dark:bg-dark-bg">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-white/80 dark:bg-dark-surface/80 backdrop-blur-xl rounded-2xl shadow-xl p-8 z-10 border border-slate-200 dark:border-slate-700"
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" onChange={clearError}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#" className="text-xs text-primary hover:text-primary-dark transition">Forgot password?</a>
            </div>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link to="/signup" className="font-medium text-primary hover:text-primary-dark transition">
              Sign up
            </Link>
          </p>
        </div>
